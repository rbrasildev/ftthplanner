        ...
        <div className={`relative ${className}`} ref={wrapperRef}>
            ...
            <button
                ...
                className={`
                    ...
                    bg-white dark:bg-slate-800 border rounded-xl transition-all duration-300
                    ${isOpen
            ...
            {isOpen && (
                <div className={`
                    absolute z-[100] left-0 right-0 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-300
                        ...
                        <div className="p-3 border-b border-slate-100 dark:border-slate-800">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-700 rounded-lg pl-10 pr-4 py-2 text-sm focus:outline-none focus:border-emerald-500 transition-colors"
                                />
                            </div>
                        </div>
                    )}
