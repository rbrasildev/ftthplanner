            ...
            {isModalOpen && createPortal(
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-white dark:bg-[#1a1d23] rounded-2xl shadow-2xl w-full max-w-2xl flex flex-col max-h-[92vh] border border-slate-200 dark:border-slate-700/50 animate-in zoom-in-95 duration-200">
                                ...
                                {(() => {
                                    ...
                                    return (
                                        <div className="mt-4">
                                            ...
                                            <div className="space-y-2 max-h-72 overflow-y-auto custom-scrollbar pr-1 border border-slate-200 dark:border-slate-700/40 rounded-xl p-3 bg-[#f9fafb] dark:bg-[#151820]/40">
                        ...
                        <div className="px-6 py-4 border-t border-slate-200 dark:border-slate-700/30 bg-[#f9fafb]/60 dark:bg-[#151820]/60 rounded-b-2xl shrink-0">
                            <ModalFooter
                                onCancel={closeModal}
