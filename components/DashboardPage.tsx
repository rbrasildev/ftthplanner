          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2, 3].map(i => (
              <div key={i} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 animate-pulse">
                ...
                <div className="h-6 bg-slate-100 dark:bg-slate-800 rounded w-3/4 mb-2"></div>
                <div className="h-3 bg-slate-50 dark:bg-slate-800/50 rounded w-1/2 mb-4"></div>
                <div className="h-10 bg-slate-50 dark:bg-slate-950/50 rounded-lg border border-slate-100 dark:border-slate-800 mb-4"></div>
                <div className="pt-3 border-t border-slate-100 dark:border-slate-800">
                  <div className="h-2 bg-slate-100 dark:bg-slate-800 rounded-full w-full mb-1.5"></div>
                  <div className="h-2 bg-slate-100 dark:bg-slate-800 rounded-full w-1/4 ml-auto"></div>
                </div>
              </div>
            ))}
          </div>
