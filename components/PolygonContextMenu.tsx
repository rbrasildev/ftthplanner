...
import { Edit, Trash2, AlertTriangle, X, Check, Hexagon, Palette } from 'lucide-react';
...
export const PolygonContextMenu: React.FC<PolygonContextMenuProps> = ({
    ...
    return (
        <div
            ref={menuRef}
            className="fixed z-[99999] bg-white dark:bg-[#1a1d23] rounded-xl shadow-2xl border border-slate-200 dark:border-slate-700/40 overflow-hidden animate-in fade-in zoom-in-95 duration-150 w-60"
            style={{
        ...
        >
            ...
            <div className="px-3 py-2.5 flex items-center gap-2.5 border-b border-slate-100 dark:border-slate-700/30">
                ...
                <div className="flex-1 min-w-0">
                    <div className="text-xs font-bold text-slate-900 dark:text-white truncate">{name}</div>
