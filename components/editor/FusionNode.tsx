        ...
        >
            ...
            >
                ...
                <div
                    ...
                    `}
                >
                    {!isLitA && isConnectedA && !isConnector && <svg viewBox="0 0 4 4" style={{ width: 4, height: 4, display: 'block', flex: 'none' }} className="pointer-events-none"><circle cx="2" cy="2" r="2" fill="#10b981" /></svg>}
                </div>
                ...
                <div
                    ...
                    `}
                >
                    {!isLitB && isConnectedB && !isConnector && <svg viewBox="0 0 4 4" style={{ width: 4, height: 4, display: 'block', flex: 'none' }} className="pointer-events-none"><circle cx="2" cy="2" r="2" fill="#10b981" /></svg>}
                </div>
