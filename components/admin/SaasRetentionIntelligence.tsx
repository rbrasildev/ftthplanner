                ...
                <div className="lg:col-span-3 bg-white dark:bg-[#1a1d23] rounded-2xl border border-slate-200 dark:border-slate-700/30 shadow-sm overflow-hidden flex flex-col">
                            ...
                            <div className="flex flex-wrap items-center gap-2">
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="pl-9 pr-4 py-2 bg-slate-50 dark:bg-[#151820] border border-slate-200 dark:border-slate-700/30 rounded-xl text-sm focus:ring-2 focus:ring-emerald-500 w-full md:w-64"
                                    />
                                </div>
                                <select
                    ...
                    <div className="overflow-x-auto flex-1">
                        <table className="w-full text-left text-sm whitespace-nowrap">
                            <thead className="bg-slate-50/50 dark:bg-[#151820]/50 text-slate-500 font-semibold uppercase text-xs tracking-wider sticky top-0 backdrop-blur z-10">
                                <tr>
