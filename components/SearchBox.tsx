        ...
        <div className="space-y-2" ref={wrapperRef}>
            ...
            <div className="relative group">
                ...
                {showResults && inputValue.trim().length >= 2 && (
                    <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-[#1a1d23] border border-slate-200 dark:border-slate-700 rounded-xl shadow-2xl z-[3000] max-h-60 overflow-y-auto p-1">
                        {results.length > 0 ? (
                            results.map((item) => (
                                <button
                                    key={item.id}
