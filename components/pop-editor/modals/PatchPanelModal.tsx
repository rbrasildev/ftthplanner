            ...
            >
                ...
                <div className="px-5 py-3 border-b border-slate-200 dark:border-slate-700/30 shrink-0">
                    {activeConnection && connectedInfo ? (
                        ...
                        <div className="flex items-center gap-2.5 px-3 py-2.5 bg-[#f9fafb] dark:bg-[#151820] border border-slate-200 dark:border-slate-700/30 rounded-xl">
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar p-4 max-h-[55vh] space-y-2 bg-[#f9fafb]/50 dark:bg-[#151820]/50">
                    {isDioSource ? (
                        // --- Show OLTs ---
                        localPOP.olts.length === 0 ? (
                            ...
                            return (
                                <div key={olt.id} className="bg-white dark:bg-[#1a1d23] rounded-xl border border-slate-200 dark:border-slate-700/30 overflow-hidden shadow-sm">
                                    ...
                                    {isExpanded && (
                                        <div className="px-4 pb-4 pt-1 space-y-3 animate-in slide-in-from-top-2 duration-200 bg-[#f9fafb]/50 dark:bg-[#151820]/50 border-t border-slate-200 dark:border-slate-700/30">
